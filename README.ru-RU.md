...
Для корректной работы с методами котроллеров необходимо, чтобы обрабатываемые классы контроллеров наследовались от класса AclessControllerParent. Для проверки аргументов методов моделей надо необходимо наследовать классы моделей от класса AclessServiceParent.
<br>
